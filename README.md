...
| 전체 디자인 |  회원 가입/로그인 | 회원 가입/로그인 |review, location 데이터 모델 구축 |  담당기능  | 회원 가입/로그인 유저 기능 |
| 발표자료 제작 | 메인화면 | 마이페이지 |front 작업물과 연결 | 담당기능   | html 템플릿 태그 변경 |
| 발표 |  지도api | 평점 모달창 | review 데이터 출력 |  담당기능 | 회원가입 |
|  |  개인정보 수정전 비밀번호 확인| 개인정보 수정 페이지 |전반적인 backend 기능 협업 |  담당기능 | 담당기능 |
